...
namespace gd::maps::v2_204 {
    inline std::unordered_map<std::string, uintptr_t> addresses = {
            ...
            {"GameManager::reloadAll",                      0x12e4b0},
            ...
            {"GameObject::determineSlopeDirection",         0x13d3c0},
            {"GameObject::m_objectID",                      0x384},
            {"GameObject::m_startPosition",                 0x340},
            {"GameObject::m_objectType",                    0x31c},
            ...
            {"GJBaseGameLayer::updateDebugDraw",            0x1986F0},
            ...
            {"GJBaseGameLayer::m_isFlipped",                0x364},
            ...
            {"HardStreak::updateStroke",                    0x226960},
            {"HardStreak::m_pulseSize",                     0x168},
            ...
            {"LevelEditorLayer::updateVisibility",          0x23fa90},
            {"LevelEditorLayer::onStopPlaytest",            0x246ea0},
            ...
            {"PauseLayer::customSetup",                     0x2b89f0},
            ...
            {"PlayerObject::m_waveTrail",                   0x628},
            ...
            {"PlayLayer::m_endPortal",                      0x2aa8},
            {"PlayLayer::m_percentageLabel",                0x2e50},
