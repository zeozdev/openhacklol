...
namespace gd {
    ...
    public:
        ...
        inline void reloadAll(bool switchingModes, bool toFullscreen, bool borderless, bool unused) {
            SETUP_METHOD(void, "GameManager::reloadAll", __thiscall, GameManager*, bool, bool, bool, bool);
            return method(this, switchingModes, toFullscreen, borderless, unused);
        }
