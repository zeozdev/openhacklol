...
namespace gd::hook::GJBaseGameLayer {
    ...
    inline static uintptr_t updateDebugDraw_addr = 0x0;
    inline static std::function<void(gd::GJBaseGameLayer*)> updateDebugDraw_hook;

    /// @brief Calls the original GJBaseGameLayer::updateDebugDraw function.
    inline static void updateDebugDraw(gd::GJBaseGameLayer* self) {
        reinterpret_cast<void (__thiscall *)(gd::GJBaseGameLayer*)>(updateDebugDraw_addr)(self);
    }

    /// @brief Wrapper for the GJBaseGameLayer::updateDebugDraw hook.
    inline void __fastcall updateDebugDrawHook(gd::GJBaseGameLayer* self) { updateDebugDraw_hook(self); }

    /// @brief Installs the hook for GJBaseGameLayer::updateDebugDraw.
    SETUP_HOOK("GJBaseGameLayer::updateDebugDraw", void, updateDebugDraw, gd::GJBaseGameLayer*)
